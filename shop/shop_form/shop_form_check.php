    ...
    <div class="container">
        <div class="row">
            ...
            <?php foreach($cart as $product): ?>
                ...
                <img src="../../product/fruits_image/<?php echo $product['image']; ?>" style="width:100px">
                <?php $ttlPrice += getPrice($product["price"], $product['num']) ;?>
            <?php endforeach; ?>
            <p>送料込み合計：<?php echo $ttlPrice ;?>　円</p>
        
            <h5>入力内容に間違いありませんか？</h5>
            <form class="form-group" method="post" action="shop_form_done.php">
                <!-- 名前登録　バリデーション -->
                ...
                <!-- 新規会員登録($order)をチェックしている場合の表示 -->
                <?php if($order==="member_register"): ?>
                    ...
                    <!-- パスワード -->
                        ...
                        <p>表示されません</p>
                        <input class="form-control" type="hidden" name="order" value="<?php echo $order; ?>">
                ...
                <?php if($okflag == true): ?>
                    <input class="btn btn-primary form-control my-3" type="submit" value="購入へ"><br>
                <?php endif; ?>
